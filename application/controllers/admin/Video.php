...
class Video extends BaseController {
    ...
    public function viewList(){
        ...
        if($this->isMasterAdmin() || $this->isInstructor()){
            ...
            $this->loadViews("admin/video/video_list", $this->global, NULL, NULL);
        }else {
    ...
    public function viewCreate(){
        ...
        if($this->isMasterAdmin() || $this->isInstructor()){
            ...
            //     print_r($page_data);
            // exit;
            $this->loadViews("admin/video/video_edit", $this->global, $page_data, NULL);
        }else {
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL , NULL);   
        }
    ...
    public function getList(){
        ...
        $out_data = array();
        $table_data['data'] = $this->Video_model->getListByCompanyID($this->session->get_userdata() ['company_id']);
