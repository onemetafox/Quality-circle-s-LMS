...
class Settings extends BaseController {
    ...
    public function theme_view(){
        ...
        if($this->isSuperAdmin()){
            ...
            $this->loadViews("admin/settings/setting_theme", $this->global, $theme, NULL);
        }else{
    ...
    public function menu_view(){
        ...
        if($this->isSuperAdmin()){
            $side_params = array('selected_menu_id' => '9');
            $this->global['sidebar'] = $this->sidebar->generate($side_params, $this->role);
            $this->loadViews("admin/settings/setting_menu", $this->global, NULL, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function save_theme(){
        ...
        redirect(base_url('admin/settings/theme'));
    }
    ...
    public function global_view(){
        ...
        if($this->isSuperAdmin()){
            ...
            //            $this->loadViews("admin/settings/setting_emailtemp", $this->global, $etmp , NULL);
    ...
    public function save_smstemp(){
        ...
        //$this->smstemp_view();
        redirect(base_url('admin/settings/smstemp'));
    }
    ...
    public function smstemp_view(){
        ...
        if($this->isSuperAdmin() || $this->isAdmin()){
            ...
            $this->loadViews("admin/settings/setting_smstemp", $this->global, $etmp, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function certificate_view(){
        ...
        if($this->isSuperAdmin() || $this->isAdmin()){
            ...
            $this->global['sidebar'] = $this->sidebar->generate($side_params, $this->role);
            $this->loadViews("admin/settings/setting_certificate_temp_list", $this->global, NULL, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function certificate_edit_view($row_id = 0){
        ...
        if($this->isSuperAdmin() || $this->isAdmin()){
            ...
            $this->loadViews('admin/settings/setting_certificate_temp_edit', $this->global, $page_data, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function general_view(){
        ...
        if($this->isSuperAdmin() || $this->isAdmin()){
            ...
            $this->loadViews("admin/settings/setting_global", $this->global, $etmp, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function save_general(){
        ...
        redirect(base_url('admin/settings/general_view'));
        //$this->general_view();
    ...
    public function emailsettings(){
        ...
        if($this->isSuperAdmin()){
            ...
            $this->loadViews("admin/settings/setting_email", $this->global, $etmp, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function saveemail(){
        ...
        redirect(base_url('admin/settings/emailsettings'));
    }
    ...
    public function trans_lang_view(){
        ...
        if($this->isSuperAdmin()){
            $side_params = array('selected_menu_id' => '9');
            $this->global['sidebar'] = $this->sidebar->generate($side_params, $this->role);
            $this->loadViews("admin/settings/setting_translations", $this->global, NULL, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function menusettings(){
        ...
        if($this->isSuperAdmin()){
            ...
            $this->loadViews("admin/settings/setting_menu", $this->global, $etmp, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function newmenu(){
        ...
        if($this->isSuperAdmin()){
            $side_params = array('selected_menu_id' => '9');
            $this->global['sidebar'] = $this->sidebar->generate($side_params, $this->role);
            $this->loadViews("admin/settings/settings_new_menu", $this->global, $etmp, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function createmenu(){
        ...
        redirect(base_url('admin/settings/menusettings'));
    }
    ...
    public function notificationsettings(){
        ...
        if($this->isSuperAdmin()){
            ...
            $this->loadViews("admin/settings/settings_notification", $this->global, $etmp, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function savenotification(){
        ...
        redirect('admin/settings/notificationsettings');
    }
	
	public function site_configuration(){
        $this->load->library('Sidebar');
        if($this->isMasterAdmin() || $this->isSuperAdmin()){			
            $side_params = array('selected_menu_id' => '9');
            $this->global['sidebar'] = $this->sidebar->generate($side_params, $this->role);
            $data = $this->Settings_model->getSiteConfiguration($where);
            $this->loadViews("admin/settings/settings_siteconfiguration", $this->global, $data, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
	...
	public function saveSiteConfigurationSetting(){
		$method = implode(',',$this->input->post('verify_by'));
		$params = array('otp_login' => $this->input->post('otp_login'), 'verify_by' => $method);
        $this->Settings_model->updateSiteConfiguration($params, $this->input->post('editid'));
        redirect('admin/settings/site_configuration');
	}
