...
class Coursecreation extends BaseController{
    ...
    public function getList(){
        if($this->isInstructor()){
            ...
            $config['base_url'] = site_url('instructor/coursecreation/getList?status=' . $status . '&sSearch=' . $search);
    ...
    public function view_course($id = NULL){
        $page_path = "instructor/coursecreation/view_course";
    ...
    public function view_row_assess($course_id = 0, $user_id = 0){
        if($this->isInstructor()){
            ...
            $this->loadViews("instructor/coursecreation/view_assess", $this->global, $page_data, NULL);
        }else{
            $this->loadViews("access", $this->global, NULL , NULL); 
        }
    }
    ...
    public function view_exam_history($course_id, $user_id){
        if($this->isInstructor()){
            ...
            $this->loadViews("instructor/coursecreation/preview", $this->global, NULL, NULL);
        }else{
            $this->loadViews("access", $this->global, NULL , NULL); 
        }
    }
    ...
    public function view_exam_certificate($course_id, $user_id){
        if($this->isInstructor()){
            ...
            $this->loadViews("instructor/coursecreation/reportCard", $this->global, NULL, NULL);
        }else{
            $this->loadViews("access", $this->global, NULL , NULL); 
        }
    }
    ...
    public function detail_course($row_id = 0){
        if($this->isInstructor()){
            $page_path = "instructor/coursecreation/detail_course";
            $course = $this->Course_model->select($row_id);
            $this->global['libraries'] = $this->Course_model->getLibrary($row_id);
            $this->global['course_name'] = $course->title;
            $this->global['course_id'] = $row_id;
    ...
    public function edit_course_tab($row_id = 0, $tab_id = 1){
        ...
        if($this->isInstructor()){
            $lang_ar = $this->Translate_model->getLanguageList(array('active_flag' => 1, 'add_flag' => 1));
            $page_data['lang_ar'] = $lang_ar['data'];
            $page_path = "instructor/coursecreation/course_edit";
            if($row_id != 0){
                $course = $this->Course_model->select($row_id);
                $this->global['libraries'] = $this->Course_model->getLibrary($row_id);
                $this->global['course_name'] = $course->title;
    ...
    public function view_course_history(){
        if($this->isInstructor()){
            $this->loadViews("instructor/coursecreation/course_history", $this->global, null, NULL);
        }else{
            $this->loadViews("access", $this->global, NULL , NULL); 
        }
    }
    ...
    public function view_certificate_history(){
        if($this->isInstructor()){
            $this->loadViews("instructor/coursecreation/certificate_history", $this->global, null, NULL);
        }else{
            $this->loadViews("access", $this->global, NULL , NULL); 
        }
    }
    ...
    public function view_quiz_history($course_id = 0, $user_id = 0){
        if($this->isInstructor()){
            ...
            $this->loadViews("instructor/coursecreation/quiz_history", $this->global, $page_data, NULL);
        }else{
            $this->loadViews("access", $this->global, NULL , NULL);  
        }
    }
    ...
    public function view_quiz_answers($group_id = 0, $user_id = 0){
        if($this->isInstructor()){
            ...
            $this->load->view('instructor/coursecreation/quiz_answers', $params, $this->global, $page_data, NULL);
        }else{
            $this->loadViews("access", $this->global, NULL , NULL);
        }
    }
