...
class Mybook extends BaseController {
    ...
    public function viewBookList() {
        ...
        $table_data['data'] = $this->Library_model->getMyBook();
        ...
        $this->loadViews("learner/mybook/book_list", $this->global, $book_data, NULL);
    }
    ...
    public function viewBookDetail($id) {
        ...
        $side_params = array('selected_menu_id' => '8');
        $this->global['sidebar'] = $this->sidebar->generate($side_params, $this->role);
        $table_data['data'] = $this->Library_model->getMyBook($id) [0];
        $book_data['book'] = $table_data['data'];
        $this->loadViews("learner/mybook/book_detail", $this->global, $book_data, NULL);
    }
}
