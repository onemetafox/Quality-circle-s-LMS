...
class Message extends BaseController {
    ...
    public function index(){
        ...
        if($this->isLearner()){           
            ...
            $this->loadViews("learner/message/inbox_list", $this->global, $page_data, NULL);
        }else{
    ...
    public function sent(){
        ...
        if($this->isLearner()){
            ...
            $this->loadViews("learner/message/sent", $this->global, $page_data, NULL);
        }else{
    ...
    public function details($update_flag = 0, $msg_id = ''){
        ...
        if($this->isLearner()){
            ...
            $this->loadViews("learner/message/details", $this->global, $page_data, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function compose(){
        ...
        if($this->isLearner()){
            ...
            $this->loadViews("learner/message/compose", $this->global, $page_data, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function favourite(){
        ...
        if($this->isLearner()){
            $side_params = array('selected_menu_id' => '10');
            $this->global['sidebar'] = $this->sidebar->generate($side_params, $this->role);
            $this->loadViews("learner/message/favourite", $this->global, NULL, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
    ...
    public function trash(){
        ...
        if($this->isLearner()){
            $side_params = array('selected_menu_id' => '10');
            $this->global['sidebar'] = $this->sidebar->generate($side_params, $this->role);
            $this->loadViews("learner/message/trash", $this->global, NULL, NULL);
        }else{
            $this->global['sidebar'] = $this->sidebar->generate();
            $this->loadViews("access", $this->global, NULL, NULL);
        }
