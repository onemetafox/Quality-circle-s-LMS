    ...
    <header class="page-header">
        ...
        <main role="main" class="container">
            <div class="container">
                ...
                if($next == $end+2):
                ?>
                <button type="button" class="btn btn-success mt-5 nextquestion" data-submit="1" data-url="<?php echo base_url()?>admin/exam/showPreviewQuestion/<?php echo $question['exam_id'];?>?next=<?=$next?>">
                    Done
                </button>
                <?php else: ?>
                    <button type="button" class="btn btn-primary mt-5 nextquestion" data-submit="0" data-url="<?php echo base_url()?>admin/exam/showPreviewQuestion/<?php echo $question['exam_id'];?>?next=<?=$next?>">
        ...
        <script>
            var  base_url = "<?php echo base_url(); ?>admin/exam/";
