...
<div id="Type_Modal" class="modal fade">
    <div class="modal-dialog" style = "max-width: 700px !important; width: 700px">
        <div class="modal-content">
            <form id="form_quiz_group" name="form_quiz_group" action="<?=base_url()?>admin/exam/save_quiz_group" method="post" novalidate="novalidate" enctype="multipart/form-data">
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        $table.dataTable({
            ...
            "ajax": {
                "type": "POST",
                "async": true,
                "url": "<?php echo base_url()?>admin/exam/getQuizGroupList",
                "data": '',
                "dataSrc": "data",
                "dataType": "json",
                "cache":    false,
	...
	function deleteExam(id) {
		(new PNotify({
			...
			$.ajax({
                url: '<?=base_url()?>admin/exam/quiz_group_delete',
                type: 'POST',
                data: {'id': id},
	...
	function changeExam(id) {
	    ...
	    $("#row_id").val(id);
        $.ajax({
            url: '<?php echo base_url()?>admin/exam/getQuizIds',
            type: 'POST',
            data: {'id': id},
            success: function (data, status, xhr) {
