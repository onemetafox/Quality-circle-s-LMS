		...
		$table.dataTable({
            ...
            "columnDefs": [{
				...
				"createdCell": function (td, cellData, rowData, row, col) {
					$(td).html('<a class="btn btn-default" href="javascript:changeExam('+cellData+')">Edit</a><span class="w-20"></span><a class="btn btn-default" href="javascript:deleteExam('+cellData+')">Delete</a><span class="w-20"></span><a class="btn btn-default" href="<?php echo base_url()?>admin/exam/showPreviewQuestion/'+cellData+'" style="margin-right: 10px;"> Preview</a>');
