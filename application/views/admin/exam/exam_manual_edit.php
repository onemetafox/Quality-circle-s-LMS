						...
						<div class="col-lg-12" data-plugin-portlet id="portlet-2">
							<section class="card card-question" id="card-2" data-portlet-item>
								...
								<div class="card-body">
									...
									<div class="row">
										<label class="col-sm-12 control-label text-sm-left pt-2">Total Pass Mark</label>
									</div>
									<div class="form-group row">
										<div class="col-sm-12">
											<input type="text" class="form-control" readonly="readonly" value="<?php echo isset($exam)&&isset($exam['total_pass_mark'])?$exam['total_pass_mark']:''; ?>">
											
										</div>
									</div>
									<div class="row">
										<label class="col-sm-12 control-label text-sm-left pt-2">Total Maximum Mark</label>
									</div>
									<div class="form-group row">
										<div class="col-sm-12">
											<input type="text" class="form-control" readonly="readonly" value="<?php echo isset($exam)&&isset($exam['total_max_mark'])?$exam['total_max_mark']:''; ?>">											
										</div>
									</div>
									<div class="row">
