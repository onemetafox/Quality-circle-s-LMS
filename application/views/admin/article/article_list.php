			...
			<section class="card">
				<header class="card-header">
					<div class="card-actions">
						<a class="btn btn-default" href="<?php echo base_url();?>admin/article/create" id="btn_add"><i class="fa fa-plus"></i> <?=$term[addnew]?></a>
					</div>
					<h2 class="card-title">Article List</h2>
				</header>
				<div class="card-body">
					<table class="table table-responsive-md table-hover mb-0" id="datatable_article" >
					</table>
					<form id="form_category" action="<?php echo base_url(); ?>admin/article/create" method="POST">
	...
	jQuery(document).ready(function() { 
		...
		$table.dataTable({
			...
			"ajax": {
                "type": "POST",
                "async": true,
				"url": "<?php echo base_url()?>admin/article/getlist",
				"data": '',		
				"dataSrc": "data",
				"dataType": "json",
				"cache":    false,
            ...
            "columnDefs": [ {
				...
				"createdCell": function (td, cellData, rowData, row, col) {
					//console.log(rowData);
				    if (rowData['article_title'] != "Online Courses" && rowData['article_title'] != "Live Classes" && rowData['article_title'] != "ILT")
            ...
            "columns": [
				...
				{ "title": "Title", "data": "article_title", "class": "text-left", "width":150, "visible": true },
