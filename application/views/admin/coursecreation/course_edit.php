...
<section role="main" class="content-body">
                              ...
                              <div class="tab-content">
                                 ...
                                 <div id="w4-profile" class="tab-pane">
                                    ...
                                    <div class="form-group row col-sm-12">
                                       ...
                                       <div class="col-sm-7">
                                          	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalLearning">Add</button>
                                       		<input type="hidden" id="learning_objectivedata" name="learning_objectivevalue" value="<?php echo isset($course_data['learning_objective'])?strip_tags($course_data['learning_objective']):''; ?>">
                                            <?php if(isset($course_data)&&!empty($course_data['learning_objective'])){ ?>
                                           	<hr />
                                           	<?php echo isset($course_data)&&isset($course_data['learning_objective'])?$course_data['learning_objective']:''; ?>
                                           	<hr />
                                           	<?php } ?>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group row col-sm-12">
                                       ...
                                       <div class="col-sm-7">
                                          	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalAttend">Add</button>
                                       		<input type="hidden" id="attenddata" name="attendvalue" value="<?php echo isset($course_data['attend'])?strip_tags($course_data['attend']):''; ?>">
                                            <?php if(isset($course_data)&&!empty($course_data['attend'])){ ?>
                                           <hr />
                                           <?php echo isset($course_data)&&isset($course_data['attend'])?$course_data['attend']:''; ?>
                                           <hr />
                                           <?php } ?>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group row col-sm-12">
                                       ...
                                       <div class="col-sm-7">
                                       <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalAgenda">Add</button>           
                                       <input type="hidden" id="agendadata" name="agendavalue" value="<?php echo isset($course_data['agenda'])?strip_tags($course_data['agenda']):''; ?>">
                                       <?php if(isset($course_data)&&!empty($course_data['agenda'])){ ?>
                                       <hr />
									   <?php echo isset($course_data)&&isset($course_data['agenda'])?$course_data['agenda']:''; ?>
                                       <hr />
                                       <?php } ?>
                                       </div>
                                    </div>
                                    ...
                                    <input type="hidden" id="aboutdata" name="aboutvalue" value="<?php echo isset($course_data['about'])?strip_tags($course_data['about']):''; ?>">
                                    <?php if(isset($course_data) && !empty($course_data['about'])){ ?>
                                    <div class="form-group row col-sm-12">
									   <?php echo isset($course_data)&&isset($course_data['about'])?$course_data['about']:''; ?>
                                   	</div>
                                    <hr />
                                    <?php } ?>
                                    <?php /* ?>
                                    ...
                                    <input type="hidden" id="prerequisitedata" name="prerequisitevalue" value="<?php echo isset($course_data['prerequisite'])?strip_tags($course_data['prerequisite']):''; ?>">
                                    <?php if(isset($course_data) && !empty($course_data['prerequisite'])){ ?>
                                    <div class="form-group row col-sm-12">
									   <?php echo isset($course_data)&&isset($course_data['prerequisite'])?$course_data['prerequisite']:''; ?>
                                   	</div>
                                    <hr />
                                    <?php } ?>
                                    <div class="form-group row col-sm-12">
   ...
   <!-- Modal -->
   <div id="myModalLearning" class="modal fade" role="dialog">
      <div class="modal-dialog modal-lg">
         <!-- Modal content-->
         <div class="modal-content">
            <div class="modal-header">
               <h4 class="modal-title">Learning Objective</h4>
            </div>
            <div class="modal-body">
               <textarea class="ckeditor form-control" name="learning_objective" rows="5" ><?php echo isset($course_data['learning_objective'])?$course_data['learning_objective']:''; ?></textarea>
            </div>
            <div class="modal-footer">
               <button type="button" class="btn btn-default addLearningContent" data-dismiss="modal" >Add</button>
   ...
   <!-- end: page -->
   <!-- Modal -->
   <div id="myModalAttend" class="modal fade" role="dialog">
      <div class="modal-dialog modal-lg">
         <!-- Modal content-->
         <div class="modal-content">
            <div class="modal-header">
               <h4 class="modal-title">Who Should Attend</h4>
            </div>
            <div class="modal-body">
               <textarea class="ckeditor form-control" name="attend" rows="5" ><?php echo isset($course_data['attend'])?$course_data['attend']:''; ?></textarea>
            </div>
            <div class="modal-footer">
               <button type="button" class="btn btn-default addAttendContent" data-dismiss="modal" >Add</button>
               <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
         </div>
      </div>
   ...
   <div id="myModalAgenda" class="modal fade" role="dialog">
      <div class="modal-dialog modal-lg">
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <textarea class="ckeditor form-control" name="agenda" rows="5" ><?php echo isset($course_data['agenda'])?$course_data['agenda']:''; ?></textarea>
            </div>
            <div class="modal-footer">
               <button type="button" class="btn btn-default addAgendaContent" data-dismiss="modal" >Add</button>
               <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
         </div>
      </div>
...
<script type="text/javascript">
	...
	$('.addAgendaContent').click(function(){
   		var agenda = CKEDITOR.instances['agenda'].getData();
   		$('#agendadata').val(agenda);
   	});
	$('.addAttendContent').click(function(){
   		var agenda = CKEDITOR.instances['attend'].getData();
   		$('#attenddata').val(agenda);
   	});
	$('.addLearningContent').click(function(){
   		var learning_objective = CKEDITOR.instances['learning_objective'].getData();
   		$('#learning_objectivedata').val(learning_objective);
   	});
</script>
<script> 
   ...
   fileActionSettings: fileActionSettings
	...
	<?php
	if(!empty($course_data['objective_img'])): ?>
		$(".upload-file2").children().hide();
		$('.upload-file2').css("background-image", "url(<?php echo base_url().$course_data['objective_img']; ?>)");
	<?php endif; ?>
	...
	<?php
	if(!empty($course_data['attend_img'])): ?>
		$(".upload-file3").children().hide();
		$('.upload-file3').css("background-image", "url(<?php echo base_url().$course_data['attend_img']; ?>)");
	<?php endif; ?>
	...
	<?php
	if(!empty($course_data['agenda_img'])): ?>
		$(".upload-file4").children().hide();
		$('.upload-file4').css("background-image", "url(<?php echo base_url().$course_data['agenda_img']; ?>)");
	<?php endif; ?>
