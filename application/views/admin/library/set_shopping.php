            ...
            <form class="form-group form-bordered" id="add-form"  method="POST" novalidate="novalidate" enctype="multipart/form-data">
                ...
                <header class="card-header">
                    <div class="card-actions">
                        <a class="btn btn-default btn_user_list" href="<?= base_url()?>admin/library/"><i class="fas fa-table"></i> <?=$term[library]?></a>
                    </div>
    ...
    jQuery(document).ready(function() {
        ...
        $('#add-form .modal-add-confirm').click(function () {
            ...
            if($('#add-form .modal-add-confirm').html().indexOf('<?=$term[shopping]?>') >= 0) {
                ...
                $.ajax({
                    url: $('#base_url').val()+'admin/library/set_price',
                    type: 'POST',
                    data: formData,
                    processData:false,
                    contentType: false,
                ...
                $.ajax({
                    url: $('#base_url').val()+'admin/library/update_price',
                    type: 'POST',
                    data: formData,
                    processData:false,
                    contentType: false,
