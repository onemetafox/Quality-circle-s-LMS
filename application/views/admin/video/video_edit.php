				...
				<article class="card">
					<header class="card-header">
						<div class="card-actions">	
							<!--  -->
							<a class="btn btn-default" href="<?php echo base_url();?>admin/video" id="btn_list"><i class="fa fa-table"></i> Video List </a>
						</div>
		
						<h2 class="card-title">Video</h2>
					</header>
					<div class="card-body">
						<form id="category_add_form" action="<?php echo base_url();?>admin/video/add" enctype="multipart/form-data" method="POST" novalidate="novalidate">
							...
							<div class="form-group row">
								<label class="col-sm-3 control-label text-sm-right pt-2">Video Title <span class="required">*</span></label>
								<div class="col-lg-6 col-sm-8">
									<input type="text" id="video_title" name="video_title" class="form-control" placeholder="eg.: Course Video" required="" maxlength="50" value="<?php echo isset($video['video_title'])?$video['video_title']:''; ?>">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-3 control-label text-sm-right pt-2">Link(YouTube embed code) <span class="required">*</span></label>
								<div class="col-lg-6 col-sm-8">
									<textarea rows="5" cols="5" id="video_link" name="video_link" class="form-control" placeholder="<iframe width="853" height="480" src="https://www.youtube.com/embed/-7PM9tGKyo8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen" required=""><?php echo isset($video['video_link'])? $video['video_link']:''; ?></textarea>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-lg-6 col-sm-8 editArea">
									...
									<textarea class="form-control form-control-lg" id="checkbox" name="video_desc" placeholder="Please Enter Description" rows="3" ><?php echo isset($video['video_desc'])? $video['video_desc']:''; ?></textarea>
								</div>
							</div>
							<div class="form-group row">
