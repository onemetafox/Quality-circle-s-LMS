				...
				<article class="card">
					<header class="card-header">
						<div class="card-actions">
							<!--  -->
							<a class="btn btn-default" href="<?php echo base_url();?>admin/eveningwrkexcercise" id="btn_list"><i class="fa fa-table"></i> Evening Work & Excercise List </a>
						</div>
						<h2 class="card-title">Evening Work & Excercise</h2>
					</header>
					<div class="card-body">
						<form id="category_add_form" action="<?php echo base_url();?>admin/eveningwrkexcercise/add" enctype="multipart/form-data" method="POST" novalidate="novalidate">                        
