                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="w4-content" class="tab-pane">
                                                <div class="form-group row">
                                                    ...
                                                    <a class="col-sm-1 btn btn-primary modal-with-form" href="<?=base_url()?>admin/live/preview_course/<?=$course_id?>">Preview</a>
                                                </div>
...
<form id="form_library_insert" action="<?=base_url()?>admin/live/insert_library" method="post" target="blank_iframe">
    ...
    (function ($) {
        ...
        active_next.on('click', function (ev) {
            ...
            if (class_name_setting.indexOf("active") > 0){   ////////////////////////////Setting////////////////////////////
                $.ajax({
                    url: $('#base_url').val()+'admin/live/save_course_setting',
                    type: 'POST',
                    data: formData,
                    processData:false,
                    contentType: false,
            ...
            if (class_name_profile.indexOf("active") > 0){   ////////////////////////////Profile////////////////////////////
                $.ajax({
                    url: $('#base_url').val()+'admin/live/save_course_profile',
                    type: 'POST',
                    data: formData,
                    processData:false,
                    contentType: false,
        ...
        $w4finish.on('click', function (ev) {
            ev.preventDefault();
            $("#form_course").attr("action", "<?=base_url()?>admin/live/save_course_profile");
            $("#form_course").submit();
        });
...
<script>
    ...
    $('.modal-create-confirm').click(function (e) {
        ...
        if($('.modal-create-confirm').html().indexOf('<?=$term[create]?>') >= 0){
            $.ajax({
                url: $('#base_url').val()+'admin/live/save_exam_page',
                type: 'POST',
            ...
            $.ajax({
                url: $('#base_url').val()+'admin/live/update_exam_page',
                type: 'POST',
    ...
    $('.modal-create-quiz').click(function (e) {
        ...
        {
            $.ajax({
                url: $('#base_url').val()+'admin/live/save_quiz_page',
                type: 'POST',
                data: {'chapter_id':$('#chapter_id').val(),
                    'course_id':$('#course_id').val(),
                    'quiz_id':$('#quiz_id').val(),
        ...
        {
            $.ajax({
                url: $('#base_url').val()+'admin/live/update_quiz_page',
                type: 'POST',
                data: {'page_id':$('#page_id').val(),
                    'quiz_id':$('#quiz_id').val(),
                    'quiz_page_title':$('#quiz_page_title').val()
    ...
    function view_function(formData, functionName, className){
        ...
        if(functionName == 'view_chapter_and_page'){
            var url = "<?php echo base_url() ?>admin/live/"+functionName;
            $.ajax({
                url: url,
                type: 'POST',
...
//                CKEDITOR.instances['editor1'].setData(data.description);
    ...
    function btnCreateChapter(){
        create_type = "chapter";
        $.ajax({
            url: "<?php echo base_url() ?>admin/live/create_temp_chapter",
            type: 'POST',
            data: {'course_id':$('#course_id').val()},
            dataType : 'json',
            success: function(data){
    ...
    function btnCreatePage(){
        create_type = "page";
        $.ajax({
            url: '<?php echo base_url() ?>admin/live/create_temp_page',
            type: 'POST',
            data: {'course_id':$('#course_id').val()},
            dataType : 'json',
            success: function(data){
    ...
    function btnCreatePageWithID(){
        ...
        $.ajax({
            url: '<?php echo base_url() ?>admin/live/create_temp_page_id',
            type: 'POST',
    ...
    function editFun(elm){
        ...
        if(pageid !='' && pageid > 0)  {
            ...
            $.ajax({
                url: $('#base_url').val()+'admin/live/check_exam_page',
                type: 'POST',
                data: {'page_id':pageid},
                success: function (data, status, xhr) {
                    if(data == '1'){
...
//        CKEDITOR.instances['editor1'].setData(pageDetail);
    ...
    function delete_self(){
        $.ajax({
            url: '<?php echo base_url() ?>admin/live/delete_self',
            type: 'POST',
    ...
    function delete_self_page(){
        $.ajax({
            url: '<?php echo base_url() ?>admin/live/delete_self_page',
            type: 'POST',
            data: {'create_chapter':'chapter','course_id':$('#course_id').val()},
            dataType : 'json',
            success: function(data){
    ...
    function save_now(){
        ...
        var url = "<?php echo base_url() ?>admin/live/update_chapter_detail";
        $.ajax({
            url: url,
            type: 'POST',
            data: {'course_id':$('#course_id').val()},
    ...
    function addblackchapter(){
        ...
        var url = "<?php echo base_url() ?>admin/live/page_available";
        $.ajax({
            url: url,
            type: 'POST',
            data: formData,
    ...
    function viewList() {
        window.location.href= '<?php echo base_url() ?>admin/live/edit_course_tab/'+$("#course_id").val()+'/2';
    }
    ...
    function page_updated(){
        ...
        var url = "<?php echo base_url() ?>admin/live/update_page_detail";
        $.ajax({
            url: url,
            type: 'POST',
            data: formData,
    ...
    function library_insert(id){
        if ($("#chapter_id").val() == 0 && $("#chapter_id").val() == "" && $("#page_id").val() == 0 && $("#page_id").val() == ""){
            ...
            $.ajax({
                url:  '<?=base_url()?>admin/live/insert_library',
                type: 'POST',
