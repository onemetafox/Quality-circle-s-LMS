			...
			<section class="card" style="width: 85%;">
				<header class="card-header">
					<div class="card-actions">
						<?php echo form_open('admin/live/edit_course/'.$course_id, array("id"=>"frm_preview")); ?>
...
<form id="form_library_insert" action="<?=base_url()?>admin/live/insert_library" method="post">
