                            ...
                            <div class="tab-content">
                                ...
                                <div id="w4-setting" class="tab-pane"  style="border: 1px solid;padding: 20px;">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-6 control-label text-sm-left pt-1" for="w4-username">Status
                                                </label>
                                                <div class="switch switch-primary">
                                ...
                                <div id="w4-profile" class="tab-pane">
                                    ...
                                    <div class="form-group row col-sm-12">
                                        <label class="col-sm-2 control-label text-sm-right pt-1" style="text-align: left !important;">Start at</label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group row col-sm-12">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="location" value="<?=$course_data['location']?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row col-sm-12">
                                        <label class="col-sm-2 control-label text-sm-right pt-1" style="text-align: left !important;">Number</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="number" value="<?=$course_data['number']?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row col-sm-12">
                                    ...
                                    <div class="form-group row col-sm-12">
                                        ...
                                        <div class="col-sm-7">
                                            <select data-plugin-selectTwo class="form-control" id="standard_id" name="standard_id">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <label class="radioBox col-sm-3">Demand
                                                <input type="radio" name = "course_type" value="2" <?php if ($course_data['course_type'] == 2):?>checked<?php endif;?>>
                                                <span class="checkmark"></span>
                                            </label>

                                            <label class="radioBox col-sm-4">ILT
                                                <input type="radio" name = "course_type" value="0" <?php if ($course_data['course_type'] == 0):?>checked<?php endif;?>>
                                                <span class="checkmark"></span>
                                            </label>
                                            <label class="radioBox col-sm-3">VILT
                                                <input type="radio" name = "course_type" value="1" <?php if ($course_data['course_type'] == 1):?>checked<?php endif;?>>
                                                <span class="checkmark"></span>
                                            </label>
...
success: function (data, status, xhr) { 
    ...
    for (var i = 0; i < standard.length; i++) {
        if(standard[i].id == standard_id){
            html += '<option value="'+standard[i].id+'" selected>'+standard[i].name+'</option>';
        }else{
