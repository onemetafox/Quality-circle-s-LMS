									...
									<li>
										...
										foreach($libraries as $chapter):?>
											...
											<?php foreach($libraries as $page):?>
												<?php if($page->parent != 0 && $page->parent == $chapter->id && $page->quiz_id == 0 && $page->status == 1):?>
...
<form id="form_library_insert" action="<?=base_url()?>admin/demand/insert_library" method="post">
