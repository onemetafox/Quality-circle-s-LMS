		...
		<div class="col-lg-12">
			<section class="card">
				...
				<div class="card-body">
					...
					<form id="form_excercise" action="<?php echo base_url(); ?>learner/eveningwrkexcercise/create" method="POST">
	...
	jQuery(document).ready(function() { 
		...
		$table.dataTable({
			...
			"ajax": {
                "type": "POST",
                "async": true,
				"url": "<?php echo base_url()?>learner/eveningwrkexcercise/getlist",
				"data": '',		
				"dataSrc": "data",
				"dataType": "json",
				"cache":    false,
