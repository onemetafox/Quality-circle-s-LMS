				...
				<article class="card">
					<header class="card-header">
						<div class="card-actions">
							<!--  -->
							<a class="btn btn-default" href="<?php echo base_url();?>learner/eveningwrkexcercise" id="btn_list"><i class="fa fa-table"></i> Evening Work & Excercise List </a>
						</div>
						<h2 class="card-title">Evening Work & Excercise</h2>
					</header>
					<div class="card-body">
						<form id="category_add_form" action="<?php echo base_url();?>learner/eveningwrkexcercise/add" enctype="multipart/form-data" method="POST" novalidate="novalidate">
                            ...
                            <?php } ?>
							<div class="form-group row">
								<label class="col-sm-3 control-label text-sm-right pt-2">Document</label>
