		...
		*/
		...
		var tbdata = $history_table.dataTable({
			...
			"ajax": {
	            "type": "POST",
	            "async": true,
				"url": "<?=base_url()?>instructor/demand/getTodayOnlineLearner/demand",
				"data": {'type':'general'},		
				"dataSrc": "data",
				"dataType": "json",
				"cache":    false,
                ...
                {         //http://localhost/ols/admin/examhistory/preview_history/24
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
						//console.log(rowData);
							...
							$(td).html('<a class="btn btn-default btn-sm" href="<?= base_url()?>instructor/demand/view_row_assess/'+rowData['course_id']+'/' + + rowData['id'] + '">View Assessment</a>');
		...
		var tbdatailt = $history_table_ilt.dataTable({
			...
			"ajax": {
	            "type": "POST",
	            "async": true,
				"url": "<?=base_url()?>instructor/demand/getTodayOnlineLearner/ilt",
				"data": {'type':'general'},		
				"dataSrc": "data",
				"dataType": "json",
				"cache":    false,
		...
		var tbdatavilt = $history_table_vilt.dataTable({
			...
			"ajax": {
	            "type": "POST",
	            "async": true,
				"url": "<?=base_url()?>instructor/demand/getTodayOnlineLearner/vilt",
				"data": {'type':'general'},		
				"dataSrc": "data",
				"dataType": "json",
				"cache":    false,
		...
		var tbdata = $history_table.dataTable({
			...
			"ajax": {
	            "type": "POST",
	            "async": true,
				"url": "<?=base_url()?>instructor/demand/getCertificateHistoryList",
				"data": {'type':'general'},		
				"dataSrc": "data",
				"dataType": "json",
				"cache":    false,
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        if(rowData['exam_title'] != '') {
                            $(td).html('<a class="btn btn-default btn-sm" href="<?= base_url()?>instructor/demand/view_row_assess/' + rowData['course_id'] + '/' + rowData['user_id'] + '">View Assessment</a>' +
                                '<a class="btn btn-default btn-sm" href="<?= base_url()?>instructor/demand/view_exam_history/' + rowData['course_id'] + '/' + rowData['user_id'] + '">View Exam</a>' +
                                '<a class="btn btn-default btn-sm" href="<?= base_url()?>instructor/demand/view_exam_certificate/' + rowData['course_id'] + '/' + rowData['user_id'] + '">View Certificate</a>');
                        }
                        else {
                            $(td).html('<a class="btn btn-default btn-sm" href="<?= base_url()?>instructor/demand/view_exam_certificate/' + rowData['course_id'] + '/' + rowData['user_id'] + '">View Certificate</a>');
                        }
                    }
                }],
	        "columns": [
