...
<div>
    <form id="print_form" method="POST" action="<?= base_url()?>instructor/coursecreation/print_exam_certificate">
...
<script>
    ...
    function pagePrint() {
        ...
        $.ajax({
            url: "<?= base_url()?>instructor/coursecreation/print_exam_certificate",
            //url:"",
            type: 'POST',
            data: {                
                content: content,
