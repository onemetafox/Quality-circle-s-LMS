    ...
    <?php endif;?>
        ...
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            <div class="content-body">
                ...
                <a class="btn btn-primary" href="<?php echo base_url()?>instructor/exam/create?row_id=<?=$exam_id?>" style="position:absolute;top: 2rem;right: 30rem;margin-right: 10px;">Done</a>
            </div>
        </div>
