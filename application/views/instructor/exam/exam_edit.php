	...
	<div class="row">
		<div class="col-lg-12">
			<section class="form-wizard" id="exam_wizard">
				<?php echo form_open('instructor/exam/add_exam_auto', array("id"=>"frm_exam")); ?>
				<header class="card-header" style="background-color: #DAD9D9;">
					...
					<div class="card-actions">
						...
						<a class="btn btn-default" href="<?php echo base_url()?>instructor/exam/showPreviewQuestion/<?=$exam['id']?>" style="margin-right: 10px;"><i class="fa fa-eye"></i> Preview</a>
