    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="card">
                ...
                <form id="quiz_create_form" action="<?php echo base_url()?>instructor/exam/create_quiz" method="post"  novalidate="novalidate" enctype="multipart/form-data">
...
<script>
    ...
    function deleteExam(id) {
        (new PNotify({
            ...
            $.ajax({
                url: '<?=base_url()?>instructor/exam/delete_quiz',
                type: 'POST',
                data: {'id': id},
