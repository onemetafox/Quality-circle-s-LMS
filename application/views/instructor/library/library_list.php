...
<section role="main" class="content-body">
                                ...
                                <footer class="card-footer">
                                    <div class="row">
                                        <div class="col-md-12 text-right">
                                            <a class="modal-with-form" href="<?= base_url()?>instructor/library/create_manual">
    ...
    <div class="modal fade" id="userModal" role="dialog">
        <div class="modal-dialog modal-lg">
            <form id = "assign_users" action="<?=base_url()?>instructor/library/assign_user" method="POST">
          <!-- Modal content-->
...
<script>
    ...
    $('.modal-create-confirm').click(function (e) {
        ...
        //import-form
        $.ajax({
            url: $('#base_url').val()+'instructor/library/createDirectory',
            type: 'POST',
            data: formData,
            processData:false,
            contentType: false,
    ...
    $('.insert-directory').click(function (e) {
        ...
        $.ajax({
            url: $('#base_url').val()+'instructor/library/insert_doc',
            type: 'POST',
    ...
    $('.copy-directory').click(function (e) {
        ...
        $.ajax({
            url: $('#base_url').val()+'instructor/library/copy_doc',
            type: 'POST',
            data: {'id1': dir_id, 'id2':file_ids},
            success: function (data, status, xhr) {
                $table.DataTable().ajax.reload('', false);
    ...
    $('.merge-form-confirm').click(function (e) {
        ...
        $.ajax({
            url: $('#base_url').val()+'instructor/library/merge_doc',
            type: 'POST',
            data: formData,
            processData:false,
            contentType: false,
    ...
    $('.modal-upload-confirm').click(function (e) {
        ...
        //import-form
        $.ajax({
            url: $('#base_url').val()+'instructor/library/upload',
            type: 'POST',
            data: formData,
            processData:false,
            contentType: false,
    ...
    $('.modal-rename-confirm').click(function (e) {
        ...
        //import-form
        $.ajax({
            url: $('#base_url').val()+'instructor/library/rename',
            type: 'POST',
            data: formData,
            processData:false,
            contentType: false,
    ...
    function unsetShopping(id) {
        $.ajax({
            url: $('#base_url').val()+'instructor/library/unsetShopping',
            type: 'POST',
            data: {'id': id},
            success: function (data, status, xhr) {
                $table.DataTable().ajax.reload('', false);
    ...
    function setShopping(id) {
        $.ajax({
            url: $('#base_url').val()+'instructor/library/setShopping',
            type: 'POST',
            data: {'id': id},
            success: function (data, status, xhr) {
                $table.DataTable().ajax.reload('', false);
    ...
    function deleteLibrary(id) {
        (new PNotify({
            ...
            $.ajax({
                url: $('#base_url').val()+'instructor/library/delete',
                type: 'POST',
                data: {id:id},
                success: function (data, status, xhr) {
                    if(status == "success") {
            ...
            "columnDefs": [{
                ...
                },
                {
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        if(rowData['name']){
                            if(rowData['file_type'] == 'DIRECTORY'){
                                $(td).html('<a href="<?= base_url()?>instructor/library/library_view/'+rowData['id']+'">'+cellData+'</a>');
                            } else if(rowData['name'].indexOf('.pdf') >= 0){
                                $(td).html('<a target="blank" href="<?= base_url()?>instructor/flipbook/view_book/'+rowData['id']+'">'+cellData+'</a>');
                            } else {
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        if(rowData['file_type'] == 'manual'){
                            if(rowData['manual_type'] == 0){
                                $(td).html('<a href="<?=base_url()?>admin/library/create_manual/'+cellData+'"><i class="fas fa-pencil-alt"></i></a><span class="w-20"></span><a href="javascript:deleteLibrary('+cellData+')" class="delete-row"><i class="far fa-trash-alt"></i></a>');
                            }else{
                                $(td).html('<a href="<?=base_url()?>admin/library/create_contract/'+cellData+'"><i class="fas fa-pencil-alt"></i></a><span class="w-20"></span><a href="javascript:deleteLibrary('+cellData+')" class="delete-row"><i class="far fa-trash-alt"></i></a>');
