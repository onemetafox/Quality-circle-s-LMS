			...
			<section class="card">
				<header class="card-header">
					<div class="card-actions">
						<a class="btn btn-default" href="<?php echo base_url();?>instructor/eveningwrk/view_create" id="btn_add"><i class="fa fa-plus"></i> <?=$term[addnew]?></a>
					</div>
				...
				<div class="card-body">
					...
					<form id="form_excercise" action="<?php echo base_url(); ?>instructor/eveningwrk/view_create" method="POST">
	...
	jQuery(document).ready(function() { 
		...
		$table.dataTable({
			...
			"ajax": {
                "type": "POST",
                "async": true,
				"url": "<?php echo base_url()?>instructor/eveningwrk/getlist",
				"data": '',		
				"dataSrc": "data",
				"dataType": "json",
				"cache":    false,
