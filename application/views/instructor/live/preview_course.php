			...
			<section class="card" style="width: 85%;">
				<header class="card-header">
					<div class="card-actions">
						<?php echo form_open('instructor/live/edit_course/'.$course_id, array("id"=>"frm_preview")); ?>
...
<form id="form_library_insert" action="<?=base_url()?>instructor/live/insert_library" method="post">
...
<script>
	...
	function changeSelect(el,id,exam_id){
        if (exam_id == "0"){
            ...
            exam_url = '<?php echo base_url()?>company/<?=$company_url?>/live/examInstruction/'+exam_id;
