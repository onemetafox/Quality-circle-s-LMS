...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-sm-12">
            <section class="card">
                <form id="add-column-form" enctype="multipart/form-data" action="<?=base_url()?>instructor/live/addLive" method="POST">
                    <header class="card-header">
                        <div class="card-actions">
                            <a class="modal-with-form" href="<?=base_url()?>instructor/live">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" value="<?php print $title ?>" id="title" name="title" class="form-control"  placeholder="title" required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" value="<?php print $subtitle ?>" id="subtitle" name="subtitle" class="form-control" placeholder="subtitle" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row " <?php $id==0?print '':print 'hidden'?>>
                            <label class="col-sm-2 control-label text-sm-right pt-2"><?=$term["startday"]?></label>
                            <div class="col-sm-3">
                                <input type="text" data-plugin-datepicker="" class="form-control" id="startday" name="startday" data-date-format="yyyy-mm-dd" value="<?php print $date ?>">
                            </div>
                        ...
                        <input type="hidden" class="form-control" name="number" id="number" value="<?=$number?>">
                        <div class="form-group row">
                           <label class="col-sm-2 control-label text-lg-right pt-2">Number</label>
                           <div class="col-sm-8">
                              <input type="text" disabled="disabled" class="form-control" value="<?=$number?>">
                           </div>
                        </div>
                        <div class="form-group row">
                         ...
                         <div class="col-sm-7 addmorehigh">
                            ...
                            <?php } } ?>
                            <input type="text" placeholder="highlight" class="highlights form-control" name="highlights[]">
                            <input type="text" placeholder="highlight" class="highlights form-control" name="highlights[]">
                            <input type="text" placeholder="highlight" class="highlights form-control" name="highlights[]">                                    
                         </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" data-plugin-markdown-editor rows="8" data-plugin-maxlength="" maxlength="140" id="about" name="about"><?php print $about ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" data-plugin-markdown-editor rows="8" data-plugin-maxlength="" maxlength="140" id="objective" name="objective"><?=$objective?></textarea>
                            </div>
                        </div>
						<div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" data-plugin-markdown-editor rows="8" data-plugin-maxlength="" maxlength="140" id="attend" name="attend"><?=$attend?></textarea>
                            </div>
                        </div>
						<div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" data-plugin-markdown-editor rows="8" data-plugin-maxlength="" maxlength="140" id="agenda" name="agenda"><?=$agenda?></textarea>
                            </div>
                        </div>
						<div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="<?php print $vilt_url ?>" id="vilt_url" name="vilt_url" class="form-control" placeholder="Url" required="">
                        </div>
                    </div>
   ...
   function get_standard_list(id){
	...
	$('#category_id').on('change',function(){		
		...
		var baseurl = '<?=base_url()?>';		
		   $.ajax({
			   url: '<?=base_url()?>instructor/training/getCourseDetail',
			   type: 'POST',
	...
	$table.dataTable({
		...
		"ajax": {
			"type": "POST",
			"async": true,
			"url": "<?=base_url()?>instructor/live/getinstructor",
			"data": '',
			"dataSrc": "data",
			"dataType": "json",
			"cache":    false,
