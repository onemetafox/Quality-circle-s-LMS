                                            ...
                                            <div id="w4-setting" class="tab-pane"  style="border: 1px solid;padding: 20px;">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" class="form-control col-sm-1 input-form" style="width: 75px;" name="pay_price" value="0">
                                                    </div>
                                                </div>
                                                <div class="form-group row" style="display: none;">
                                          ...
                                          <div class="form-group row">
                                               ...
                                               <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6" style="padding-left: 0px;" id="user_table">
                                                        <label class="col-sm-12 control-label text-sm-left pt-1" for="w4-username"><?=$term['selectuser']?></label>
                                                        <div class="col-sm-12">
                                            ...
                                            <div id="w4-content" class="tab-pane">
                                                <div class="form-group row">
                                                    ...
                                                    <a class="col-sm-1 btn btn-primary modal-with-form" href="<?=base_url()?>instructor/demand/preview_course/<?=$course_data['id']?>">Preview</a>
                                                </div>
                                            ...
                                            <div id="w4-content-new-page" class="tab-pane">
                                                <div class="form-group row">
                                                    ...
                                                    <a class="btn btn-primary modal-with-form" href="javascript:void(0)" onclick="viewList()">View List</a>
                                            ...
                                            <div id="w4-profile" class="tab-pane">
                                                ...
                                                <!---------------------------according to admin course------------------------------->
                                                    ...
                                                    <div class="form-group row col-sm-12">
                                                       ...
                                                       <div class="col-sm-7">
                                                          <textarea class="form-control" name="learning_objective" rows="5" id="learning_objective"><?=nl2br($course_data['learning_objective'])?></textarea>
                                                       </div>
                                                    </div>
                                                    <div class="form-group row col-sm-12">
                                                       <label class="col-sm-2 control-label text-sm-right pt-1" style="text-align: left !important;">Who Should Attend</label>
                                                       <div class="col-sm-7">
                                                          <textarea class="form-control" name="attend" rows="5" id="attend"><?=nl2br($course_data['attend'])?></textarea>
                                                       </div>
                                                    </div>
                                                    <div class="form-group row col-sm-12">
                                                       <label class="col-sm-2 control-label text-sm-right pt-1" style="text-align: left !important;">Agenda</label>
                                                       <div class="col-sm-7">
                                                          <textarea class="form-control" name="agenda" rows="5" id="agenda"><?=nl2br($course_data['agenda'])?></textarea>
                                                       </div>
                                                    </div>
                                                    <div class="form-group row">
                                                ...
                                                <div class="form-group row col-sm-12">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <select data-plugin-selectTwo class="form-control" onchange="getCategoryTitle()" id="category_id" name="category_id">
...
<form id="form_library_insert" action="<?=base_url()?>instructor/demand/insert_library" method="post" target="blank_iframe">
...
function remove_sessionDateTime(){
    ...
    $("#quiz_chapter_id").change(function(){
        $.ajax({
            type: "POST",
            url: "<?=base_url()?>instructor/demand/getPageByChapterId",
    ...
    (function ($) {
        ...
        active_next.on('click', function (ev) {
            ...
            if (class_name_setting.indexOf("active") > 0){   ////////////////////////////Setting////////////////////////////
                $.ajax({
                    url: $('#base_url').val()+'instructor/demand/save_course_setting',
                    type: 'POST',
                    data: formData,
                    processData:false,
                    contentType: false,
            ...
            if (class_name_profile.indexOf("active") > 0){   ////////////////////////////Profile////////////////////////////
                $.ajax({
                    url: $('#base_url').val()+'instructor/demand/save_course_profile',
                    type: 'POST',
                    data: formData,
                    processData:false,
                    contentType: false,
        ...
        $w4finish.on('click', function (ev) {
            ev.preventDefault();
            $("#form_course").attr("action", "<?=base_url()?>instructor/demand/save_course_profile");
            $("#form_course").submit();
        });
    ...
    jQuery(document).ready(function() {
        ...
        $table.dataTable({
            ...
            "ajax": {
                "type": "POST",
                "async": true,
                "url": "<?=base_url()?>instructor/demand/getinstructor",
                "data": '',
                "dataSrc": "data",
                "dataType": "json",
                "cache":    false,
        ...
        $user_table.dataTable({
            ...
            "ajax": {
                "type": "POST",
                "async": true,
                "url": "<?=base_url()?>instructor/demand/getuser",
                "data": '',
                "dataSrc": "data",
                "dataType": "json",
                "cache":    false,
    ...
    $(function() {
        ...
        $(".file-input-overwrite").fileinput({
            ...
            initialPreview: [
                "<?php if($course_data['img_path'] != null) echo base_url().$course_data['img_path']; ?>"
            ],
...
<script>
    ...
    $('.modal-create-confirm').click(function (e) {
        ...
        {
            $.ajax({
                url: $('#base_url').val()+'instructor/demand/update_exam_page',
                type: 'POST',
                data: {'chapter_id':$('#chapter_id').val(),
                    'exam_id':$('#exam_id').val(),
                    'exam_page_title':$('#exam_page_title').val(),
    ...
    $('.modal-create-quiz').click(function (e) {
        ...
        else
        {
            ...
            $.ajax({
                url: $('#base_url').val()+'instructor/demand/update_quiz_page',
                type: 'POST',
    ...
    function view_function(formData, functionName, className){
        ...
        if(functionName == 'view_chapter_and_page'){
            var url = "<?php echo base_url() ?>instructor/demand/"+functionName;
            $.ajax({
                url: url,
                type: 'POST',
...
//                CKEDITOR.instances['editor1'].setData(data.description);
    ...
    function btnCreateChapter(){
        create_type = "chapter";
        $.ajax({
            url: "<?php echo base_url() ?>instructor/demand/create_temp_chapter",
            type: 'POST',
            data: {'course_id':$('#course_id').val()},
            dataType : 'json',
            success: function(data){
    ...
    function btnCreatePage(){
        create_type = "page";
        $.ajax({
            url: '<?php echo base_url() ?>instructor/demand/create_temp_page',
            type: 'POST',
    ...
    function btnCreatePageWithID(){
        ...
        $.ajax({
            url: '<?php echo base_url() ?>instructor/demand/create_temp_page_id',
            type: 'POST',
    ...
    function editFun(elm){
        ...
        if(pageid !='' && pageid > 0)  {
            ...
            $.ajax({
                url: $('#base_url').val()+'instructor/demand/check_exam_page',
                type: 'POST',
                data: {'page_id':pageid},
                success: function (data, status, xhr) {
                    if(data == '2'){
...
success: function(data){
    ...
    function delete_self(){
        $.ajax({
            url: '<?php echo base_url() ?>instructor/demand/delete_self',
            type: 'POST',
    ...
    function delete_self_page(){
        $.ajax({
            url: '<?php echo base_url() ?>instructor/demand/delete_self_page',
            type: 'POST',
            data: {'create_chapter':'chapter','course_id':$('#course_id').val()},
            dataType : 'json',
            success: function(data){
    ...
    function save_now(){
        ...
        var url = "<?php echo base_url() ?>instructor/demand/update_chapter_detail";
        $.ajax({
            url: url,
            type: 'POST',
    ...
    function addblackchapter(){
        ...
        var url = "<?php echo base_url() ?>instructor/demand/page_available";
        $.ajax({
            url: url,
            type: 'POST',
            data: formData,
    ...
    function viewList() {
        window.location.href= '<?php echo base_url() ?>instructor/demand/edit_course_tab/'+$('#course_id').val()+'/2';
    }
    ...
    function page_updated(){
        ...
        var url = "<?php echo base_url() ?>instructor/demand/update_page_detail";
        $.ajax({
            url: url,
            type: 'POST',
            data: formData,
    ...
    function library_insert(id){
        if ($("#chapter_id").val() == 0 && $("#chapter_id").val() == "" && $("#page_id").val() == 0 && $("#page_id").val() == ""){
            ...
            $.ajax({
                url:  '<?=base_url()?>instructor/demand/insert_library',
                type: 'POST',
