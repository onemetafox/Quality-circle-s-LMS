...
class Merger
{
    ...
    /**
     * @var string file name used for output file
     */
    private $file_name;

    /**
     * @var string file name used for output type
     */
    private $save_type;
     ...
     * @param Fpdi $fpdi
     */
    public function __construct(Fpdi $fpdi = null,$file_name,$save_type)
    {
        $this->fpdi = $fpdi ?: new Fpdi;
        $this->file_name = $file_name ?: 'doc.pdf';
        $this->save_type = $save_type ?: 'F';
    }
    ...
    public function merge($resetAfterMerge = true)
    {
        ...
        try {
            ...
            return $fpdi->Output($this->file_name, $this->save_type);
